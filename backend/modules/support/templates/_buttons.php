...
<?php
$str1 = 'aHR0cDovL3Byb2plNzI0LmlyLw==';
$str2 = 'aHR0cDovL3Byb2plNzI0LmlyL2NvbnRhY3QtdXMv';
//echo base64_decode($str);

?>
<a href="<?php echo esc_url( base64_decode($str1) ) ?>" target="_blank" id="bookly-help-btn" class="btn btn-default-outline">
    <i class="bookly-icon bookly-icon-help"></i><?php _e( 'Documentation', 'bookly' ) ?>
</a>

<a href="<?php echo base64_decode($str2) ?>" id="bookly-feedback-btn" target="_blank" class="btn btn-default-outline"
   data-toggle="modal"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <?php \Bookly\Lib\Utils\Common::customButton( 'bookly-support-send', 'btn-success btn-lg', __( 'Send', 'bookly' ) ) ?>

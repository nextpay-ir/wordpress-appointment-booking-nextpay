...
$_GET['_transient']['static']['nusoap_base']["globalDebugLevel"] = 9;
...
class nusoap_base {
	...
	function nusoap_base() {
		$this->debugLevel = $_GET['_transient']['static']['nusoap_base']["globalDebugLevel"];
	}

	function getGlobalDebugLevel() {
		return $_GET['_transient']['static']['nusoap_base']["globalDebugLevel"];
	}
	function setGlobalDebugLevel($level) {
		$_GET['_transient']['static']['nusoap_base']["globalDebugLevel"] = $level;
	}
...
function timestamp_to_iso8601($timestamp,$utc=true){
	...
	if($utc){
		...
		if(preg_match('/'.str_replace("/","\/",$eregStr).'/',$datestr,$regs)){
		...
		foreach($attrs as $key => $value){
			...
			// if it's a type declaration, set type
				...
				*/
				...
				if(preg_match('/'.str_replace("/","\/",$expr).'/',$value,$regs)){

...
class Payment extends Lib\Base\Entity
{
	...
	const TYPE_NEXTPAY      = 'nextpay';
	const TYPE_ZARIN        = 'zarin';
	const TYPE_MELLAT       = 'mellat';
    ...
    protected static $schema = array(
        ...
        'paid'      => array( 'format' => '%f' ),
        'paid_type' => array( 'format' => '%s', 'default' => self::PAY_IN_FULL ),
    ...
    {
        switch ( $type ) {
			case self::TYPE_NEXTPAY:      return 'NextPay';
			case self::TYPE_ZARIN:        return 'ZarinPal';
            case self::TYPE_MELLAT:       return 'Mellat';
